...
In the below @fig-ConflictCreated you can see that the conflict has been created in the _example.qmd_ file. The @fig-Commandlineconflict shows the same message in the command line. 
